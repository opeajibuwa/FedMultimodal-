...
if __name__ == '__main__':
    ...
    # Use the specified feature extractors (or fall back to defaults)
    img_feature_type = getattr(args, 'img_feat', 'mobilenet_v2')
    text_feature_type = getattr(args, 'text_feat', 'mobilebert')
    ...
    for client_id in tqdm(dm.client_ids):
        ...
        dataloader_dict[client_id] = dm.set_dataloader(
            ...
            default_feat_shape_a=np.array([1, constants.feature_len_dict[img_feature_type]]),
            default_feat_shape_b=np.array([32, constants.feature_len_dict[text_feature_type]])
        )
    ...
    for fold_idx in range(1, 6):
        ...
        global_model = ImageTextClassifier(
            ...
            img_input_dim=constants.feature_len_dict[img_feature_type], 
            text_input_dim=constants.feature_len_dict[text_feature_type],
            d_hid=args.hid_size,
            en_att=args.att,
